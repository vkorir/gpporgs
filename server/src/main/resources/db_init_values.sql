...
-- INSERT INTO users(email, is_admin, has_access, created, number_of_login) VALUES
-- ('victor.korir@berkeley.edu', TRUE, TRUE, '2020-10-01T07:00Z', 0),
-- ('cchowdhry@berkeley.edu', TRUE, TRUE, '2020-10-01T07:00Z', 0);
-- UNLOCK TABLES;