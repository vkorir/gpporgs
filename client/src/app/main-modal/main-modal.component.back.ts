...
export class MainModalComponent implements OnInit {
  ...
  contactx(contact: any) {
    console.log(contact);
  }

  filteredTypes(): Type[] {
    return this.types.filter(type => {
      return !this.disableControl || (this.disableControl && this.organization.controls.type.value.id === type.id);
    });
    return [];
  }
  ...
  compareId(option: any, value: any): boolean {
